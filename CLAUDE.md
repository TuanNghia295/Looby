...
This project is indexed by GitNexus as **Looby** (173 symbols, 300 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/Looby/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/Looby/context` | Codebase overview, check index freshness |
| `gitnexus://repo/Looby/clusters` | All functional areas |
| `gitnexus://repo/Looby/processes` | All execution flows |
| `gitnexus://repo/Looby/process/{name}` | Step-by-step execution trace |
